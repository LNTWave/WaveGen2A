...
var guiProductType          = PRODUCT_TYPE_PRO; // String based on the 3 digits in the SKU  590Nxxx. (Default to PRO)
...
var guiOperator             = "";               // String based on 700 number from Cel-Fi.
var guiOperatorCode         = "";               // 4 digit operator code.
var guiUserFirstName        = "";               // Filled in from the cloud.  
...
var guiSoftwareCheckPercentComplete = 0;        // Used with V1 ICD to indicate to user on dashboard that app is checking for update.
...
var guiRelayingFlag         = false;            // Flag: true when any radio is relaying.
var guiEsErrorCode          = 0;                // 0 is no error

var guiSwNames              = ["UnSec Cfg", "NU_ART", "NU_EVM", "NU_PIC", "Sec Cfg", "Bluetooth", "NU_Ares", "CU_ART", "CU_PIC", "CU_Ares"];         // Software image names
const SWVER_NU_UCFG         = 0;    // Made the same index as the download order but does not have to be.
const SWVER_NU_ART          = 1;
const SWVER_NU_EVM          = 2;
const SWVER_NU_PIC          = 3;
const SWVER_NU_SCFG         = 4;
const SWVER_CU_BT           = 5;
const SWVER_NU              = 6;
const SWVER_CU_ART          = 7;
const SWVER_CU_PIC          = 8;
const SWVER_CU              = 9;
...
function DumpDataTables()
{
    ...
    PrintLog(1, "guiRelayingFlag        = " + guiRelayingFlag );                   // true if any radio is relaying.  Based on "Relaying" values
    PrintLog(1, "guiBoost               = " + guiBoost );                          // CalculateUniiBars().
    PrintLog(1, "guiNuBars              = " + guiNuBars );                         // CalculateNuBars().
    PrintLog(1, "guiEsErrorCode         = " + guiEsErrorCode );  
...
{
    PrintLog(1, "Connect pressed by user to confirm BT device." );
...
{
    // If we are on the MAIN screen, i.e. "Syncing..." then get off the main page and go to dashboard before starting download.
    if( guiCurrentMode == PROG_MODE_MAIN )
    {
        RequestModeChange(PROG_MODE_TECH);
    }
    
    RequestModeChange(PROG_MODE_DOWNLOAD);
    Dld.handleDldKey();
...
//.................................................................................................................
function FillSwCelFiVers()
{
    // Version info from the hardware... 
    guiSwCelFiVers[SWVER_NU_UCFG] = nxtySwVerNuUCfg;
    guiSwCelFiVers[SWVER_NU_ART]  = nxtySwVerNuArt;
    guiSwCelFiVers[SWVER_NU_EVM]  = nxtySwVerNuEvm;
    guiSwCelFiVers[SWVER_NU_PIC]  = nxtySwVerNuPic;
    guiSwCelFiVers[SWVER_NU_SCFG] = nxtySwVerNuSCfg;
    guiSwCelFiVers[SWVER_NU]      = nxtySwVerNuCf;
    guiSwCelFiVers[SWVER_CU_ART]  = nxtySwVerCuArt;
    guiSwCelFiVers[SWVER_CU_BT]   = nxtySwVerCuBt;
    guiSwCelFiVers[SWVER_CU_PIC]  = nxtySwVerCuPic;
    guiSwCelFiVers[SWVER_CU]      = nxtySwVerCuCf;
}

//.................................................................................................................
function FillSwCldVers()
{
    guiSwCldVers[SWVER_NU_UCFG] = nxtySwVerNuUCfgCld;
    guiSwCldVers[SWVER_NU_ART]  = nxtySwVerNuArtCld;
    guiSwCldVers[SWVER_NU_EVM]  = nxtySwVerNuEvmCld;
    guiSwCldVers[SWVER_NU_PIC]  = nxtySwVerNuPicCld;
    guiSwCldVers[SWVER_NU_SCFG] = nxtySwVerNuSCfgCld;
    guiSwCldVers[SWVER_NU]      = nxtySwVerNuCfCld;
    guiSwCldVers[SWVER_CU_ART]  = nxtySwVerCuArtCld;
    guiSwCldVers[SWVER_CU_BT]   = nxtySwVerCuBtCld;
    guiSwCldVers[SWVER_CU_PIC]  = nxtySwVerCuPicCld;
    guiSwCldVers[SWVER_CU]      = nxtySwVerCuCfCld;
}
