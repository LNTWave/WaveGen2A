...
//                        document.getElementById("p_id").innerHTML = ""; 
            ...
            case REG_STATE_CELL_INFO_REQ:
            {
                ...
                {
                    // Send a message to the NU Cel-Fi unit to gather Cell Info...         
            ...
            case REG_STATE_CELL_INFO_RSP:
            {
                ...
                {   
                    ...
                    else if( (nxtyRxStatusIcd <= V1_ICD) && (nxtyLastNakType == NXTY_NAK_TYPE_UNIT_REDIRECT) )
                    {
                        ...
                        if( RegNakCount++ >= REG_NAK_COUNT_MAX )
                        {
                            ...
                            ShowAlertPopUpMsg("CRC Error Max.", "Failed to receive Authentication response from Cel-Fi device.");
                        }
                    }                    
...
//                        if( nxtyLastNakType == NXTY_NAK_TYPE_CRC )
                    ...
                    if( regTimeoutCount >= REG_LOOP_COUNT_MAX )
                    {
                        ...
                        ShowAlertPopUpMsg("Timeout.", "No Authentication response from Cel-Fi device.");
                    }
